...
module.exports = (router) => {
                        ...
                        if(err){
                            ...
                            if(err.code === 11000) {
                                ...
                                if(err.errors) {
                                    ...
                                    res.json({ success: false, message: 'Could not register user. Error: ', err }); // Return error if not related to validation
                                }
                            }
  ...
  ================================================ */
    //any route come after this middleware will automatically run this middleware
